...
**[📚 Read the Documentation →](/getting-started/quick-start)**
...
For fully autonomous overnight development, use the Ralph Wiggum plugin **inside Claude Code**:
...
> **See the [24/7 Development guide](/autonomous-development/24-7-development) for detailed setup and usage.**
...
See [24/7 Development](/autonomous-development/24-7-development) for details.
...
- **[Slash Commands](/core-concepts/slash-commands)** - Available commands
- **[Quality Gates](/autonomous-development/quality-gates)** - Quality checks
- **[State Management](/core-concepts/state-management)** - Track progress
