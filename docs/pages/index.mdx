...
<div style="text-align: center;">
  <img src="/assets/agentful.jpeg" alt="Agentful Logo" width="200" />
</div>
...
flowchart TB
    subgraph Setup["🚀 GET STARTED"]
        Init([1️⃣ Initialize<br/>npx agentful init])
...
- ✅ All tests passing
- ✅ No type errors (TypeScript, mypy, etc. - adapts to your stack)
- ✅ No lint errors
