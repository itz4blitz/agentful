...
**Framework-Specific Agents:** For framework-specific patterns (Next.js, React Router, Vue, etc.), the [Architect Agent](/agents/architect) generates specialized agents. Use those for framework-specific implementation details.
...
3. **NEVER modify code outside your domain** - stay in frontend scope
4. Skip accessibility considerations
5. Create overly complex components (break them down)
6. Mix concerns (data fetching in presentation components)
...
- [Backend Agent](/agents/backend) - Server-side implementation (do not modify)
- [Architect Agent](/agents/architect) - Generates framework-specific agents
- [Tester Agent](/agents/tester) - Writes tests for your frontend components
- [Reviewer Agent](/agents/reviewer) - Validates your frontend implementation
- [Orchestrator Agent](/agents/orchestrator) - Coordinates frontend development
