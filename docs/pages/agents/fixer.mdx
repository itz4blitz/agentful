...
- [Reviewer Agent](/agents/reviewer) - Detects issues for Fixer to resolve
- [Backend Agent](/agents/backend) - Code that may need fixing
- [Frontend Agent](/agents/frontend) - Code that may need fixing
- [Tester Agent](/agents/tester) - Adds tests when Fixer can't reach coverage
- [Orchestrator Agent](/agents/orchestrator) - Coordinates fix workflow
