...
**Framework-Specific Agents:** For framework-specific patterns (Next.js, NestJS, Express, etc.), the [Architect Agent](/agents/architect) generates specialized agents. Use those for framework-specific implementation details.
...
3. **NEVER modify code outside your domain** - stay in backend scope
4. Skip error handling
5. Hardcode secrets or configuration
6. Mix concerns (e.g., database queries in controllers)
7. Return different response formats inconsistently
...
- [Frontend Agent](/agents/frontend) - Client-side implementation (do not modify)
- [Architect Agent](/agents/architect) - Generates framework-specific agents
- [Tester Agent](/agents/tester) - Writes tests for your backend code
- [Reviewer Agent](/agents/reviewer) - Validates your backend implementation
- [Orchestrator Agent](/agents/orchestrator) - Coordinates backend development
