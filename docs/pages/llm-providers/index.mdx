...
| **[DeepSeek](#TODO)** | deepseek-v3.2 | 8x cheaper | ⭐ Easy | Thinking mode + tools, agent training, high performance |
| **[Gemini](#TODO)** | gemini-2.5-pro | Similar | ⭐⭐ Medium | 1M context, MCP native, long documents |
| **[OpenAI](#TODO)** | gpt-4.1, gpt-5.2 | Similar/higher | ⭐ Easy | Proven reliability, Responses API, wide ecosystem |
| **[Qwen](#TODO)** | qwen3-coder-480b | Open-source | ⭐⭐ Medium | Agentic coding, MCP support, open weights |
...
Based on your needs:
- **Cost optimization** → [GLM-4.7](/llm-providers/glm) or [DeepSeek](#TODO)
- **Math/algorithms** → [GLM-4.7](/llm-providers/glm)
- **Long context** → [Gemini](#TODO)
