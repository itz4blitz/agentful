...
| **[DeepSeek](/llm-providers/deepseek)** | deepseek-v3 | 8x cheaper | ⭐⭐ Medium | Thinking mode, math reasoning, very cheap |
| **[Gemini](/llm-providers/gemini)** | gemini-2.0-flash | 40x cheaper | ⭐⭐ Medium | 1M context, multimodal, long documents |
| **[OpenAI](/llm-providers/openai)** | gpt-4o | Similar | ⭐⭐ Medium | Requires LiteLLM proxy, proven reliability |
...
Based on your needs:
- **Cost optimization** → [GLM-4.7](/llm-providers/glm) or [DeepSeek](/llm-providers/deepseek)
- **Math/algorithms** → [GLM-4.7](/llm-providers/glm)
- **Long context** → [Gemini](/llm-providers/gemini)
- **Privacy** → [Local models](/llm-providers/local)
