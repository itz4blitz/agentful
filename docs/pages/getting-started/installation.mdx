...
description: Learn how to install and initialize Agentful in your project using npx agentful init.
---
...
After running `npx agentful init`, you'll see:
...
```bash
npx agentful init --path /path/to/project
```
