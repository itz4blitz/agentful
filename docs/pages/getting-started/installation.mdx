...
**Simple Projects** → Creates PRODUCT.md at root (flat structure, also supported for simple workflows)
- Best for: Learning projects, MVPs, single-purpose apps
- Everything in one place
- Easier to get started

**Large/Complex Projects** → Creates `.claude/product/index.md` with domains (hierarchical)
