...
**Simple Projects** → Creates `PRODUCT.md` (flat, single-file at root)
- Best for: Learning projects, MVPs, single-purpose apps
- Everything in one place
- Easier to get started

**Large/Complex Projects** → Creates `.claude/product/` with domain directories
- Best for: Multi-domain apps, large teams, long-term projects
- Organized by domains/features
- Scales better for big projects

**Detection Criteria:**
- Number of detected domains (≥3 triggers hierarchical)
- Multiple frameworks (≥2 triggers hierarchical)
...
```
your-project/
├── PRODUCT.md              # ← Edit this: your product spec (simple projects)
...
│   │   ├── index.md        # Main product specification
...
This skips the intelligent detection and always creates the simple `PRODUCT.md` structure.
