...
Visit **[agentful.app](https://agentful.app)** to:
- Visual configuration builder
- Customize agents, skills, and hooks
- Generate installation command
- Share configuration with team

Then copy and run the generated command.

### Option B: Default Installation (Fast)

Install with all components (recommended for most projects):

```bash
# Default installation - All components
npx @itz4blitz/agentful init

# Minimal installation - Backend-only (for simple scripts/APIs)
...
agentful creates `.claude/product/index.md` for your product specification.
...
### Web Configurator
Visually customize your installation
