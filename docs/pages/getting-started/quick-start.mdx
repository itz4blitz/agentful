...
### For Simple Projects (Flat PRODUCT.md)

If agentful created `PRODUCT.md` in your project root, edit it:
...
### For Complex Projects (Hierarchical .claude/product/)

If agentful created `.claude/product/`, edit `.claude/product/index.md`:
...
Reading product spec from: PRODUCT.md (or .claude/product/index.md)
...
- Reads from `PRODUCT.md` OR `.claude/product/index.md`
...
**Key Files:**
- `PRODUCT.md` - Your product spec (simple structure, auto-detected)
- `.claude/product/index.md` - Main product spec (hierarchical structure, auto-detected)
...
- **Simple projects** (< 3 domains) → `PRODUCT.md` created automatically
- **Complex projects** (≥ 3 domains) → `.claude/product/` created automatically
