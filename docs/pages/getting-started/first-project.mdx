...
description: Learn how to create your first structured project with agentful. A complete walkthrough from initialization to completion.
---

# Your First Project

Build your first complete structured project with agentful. We'll create a **Task Management App** together, demonstrating both simple and complex project structures.
...
- How agentful builds complete features through structured development
...
Next steps:
  ...
  2. Run: claude
  3. Type: /agentful (natural) or /agentful-start (structured)
```
...
For this tutorial, we'll use the **flat `PRODUCT.md`** structure that agentful created (also supported for simple projects).

> **Note:** While `PRODUCT.md` works great for simple projects, `.claude/product/index.md` (hierarchical) is preferred for better organization. Both are auto-detected!
...
- agentful auto-detects and works seamlessly with either structure
...
### Option B: Structured Mode (Hands-off)

**Best for:** Hands-off development, continuous building, maximum productivity
...
3. Start building features through structured development
4. Continue until complete or paused
5. Only stop when it needs a decision

**Benefits:**
- No micromanagement needed
- Works continuously with Ralph Wiggum for extended sessions
- Maximum productivity
- Predictable workflow

**For this tutorial**, we'll use **structured mode** to see agentful's full power, but you can switch to conversation mode anytime!
...
**To answer using structured mode:**
...
**If using PRODUCT.md** (flat structure - also supported):
...
**If using hierarchical structure** (.claude/product/ - preferred):

Edit `.claude/product/index.md` or add a new domain file like `.claude/product/domains/tasks/index.md`:
```markdown
### 6. Task Due Dates - MEDIUM
**Description**: Add due dates to tasks
...
...
- **Hierarchical (`.claude/product/index.md`)** - **Preferred** for organization and scalability
- **Flat (`PRODUCT.md`)** - Also supported for simple projects
...
- **Structured (`/agentful-start`)** - Hands-off, continuous development
...
- Run continuous structured development for big projects with Ralph Wiggum
...
3. Use conversation mode when learning, structured mode for productivity
