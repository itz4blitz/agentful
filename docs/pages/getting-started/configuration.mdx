...
- **Templates** - Customize product spec (`.claude/product/index.md` or `PRODUCT.md`) and `CLAUDE.md`
...
**This is the preferred structure** for better organization and scalability.
...
|--------|----------|----------|
| Flat (PRODUCT.md) | MVP, prototype, very small project | Simplest, fastest setup (also supported) |
| Flat (.claude/product/index.md) | Want organization, but small project | Keeps root clean, still simple |
| Hierarchical (.claude/product/domains/) | **Most projects**, 20+ features, teams | **Preferred:** Domain-driven, scalable, organized |

**Recommendation:**
- **Preferred:** `.claude/product/index.md` with domains/ (hierarchical) for better organization
- **Also supported:** `PRODUCT.md` (flat) for very simple projects
- Both are auto-detected - use whichever fits your project!
...
**Example: Create custom workflow in `.claude/commands/my-workflow.md`:**

> **Note:** This is an example template. You would create this file yourself in your project.
...
→ See individual agent docs in [/agents](/agents)
