...
Like [agents](/agents#three-tier-architecture), skills are organized into three categories:
...
**Skills are shared across all agents** - any agent can reference any skill. See [our philosophy](/#our-philosophy) for details.
