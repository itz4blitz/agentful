...
**Related Commands:**
- [/agentful-start](./agentful-start) - Begin autonomous development (use after product planning)
- [/agentful-status](./agentful-status) - Track implementation progress
- [/agentful-decide](./agentful-decide) - Resolve architectural decisions during development

**Related Agents:**
- [Orchestrator Agent](/agents/orchestrator) - Reads product spec to plan implementation
- [Architect Agent](/agents/architect) - Uses product spec for system design
- [All Agents](/agents) - How agents use product specifications
