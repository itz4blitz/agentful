...
- [`/agentful-start`](./agentful-start.mdx) - Start autonomous development
- [`/agentful-status`](./agentful-status.mdx) - Check detailed progress
- [`/agentful-decide`](./agentful-decide.mdx) - Answer pending decisions
- [`/agentful-validate`](./agentful-validate.mdx) - Run quality checks
