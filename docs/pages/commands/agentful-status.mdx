...
The `/agentful-status` command provides a comprehensive overview of your autonomous work session. It displays:
...
**What it tells you:**
- **Product**: Name from product spec (.claude/product/index.md)
...
| `.claude/product/index.md` | Product name, feature list | Markdown |
