...
| `PRODUCT.md` | Product name, feature list | Markdown |
...
- [State Files](/core-concepts/state-management) - Understanding state.json structure
- [Completion Tracking](/core-concepts/state-management) - How completion is calculated
