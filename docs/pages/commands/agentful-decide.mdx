...
- [/agentful-start](./agentful-start) - Continue after resolving decisions
- [/agentful-status](./agentful-status) - Check if decisions are pending
- [Decision Templates](/commands/agentful-decide) - Creating reusable decision patterns
- [State Management](/core-concepts/state-management) - How decisions affect state
- [Orchestrator](/agents/orchestrator) - How orchestrator uses decisions
