...
Pipeline orchestration enables agentful to run AI agents in complex, long-running workflows (5-30 minutes) with parallel execution, dependencies, and robust error handling.
...
- [Pipeline Definition Reference](/pipelines/definition)
- [CI/CD Integration Guide](/pipelines/cicd)
- [Troubleshooting](/pipelines/troubleshooting)
- [Advanced Patterns](/pipelines/advanced)
