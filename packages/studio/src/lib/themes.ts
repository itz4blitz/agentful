...
export const themes: Record<string, Theme> = {
  ...
  spotify: {
    ...
    colors: {
      background: '0 0% 100%',
      foreground: '165.48 2% 35%',
      primary: '153.85 17% 67%',
      'primary-foreground': '169.99 2% 99%',
      secondary: '238.66 2% 90%',
      'secondary-foreground': '266.02 2% 20%',
      accent: '240.73 2% 90%',
      'accent-foreground': '165.48 2% 35%',
      muted: '240.73 2% 90%',
      'muted-foreground': '268.53 3% 50%',
      destructive: '20.96 24% 61%',
      'destructive-foreground': '0 0% 98%',
      border: '238.46 1% 94%',
      input: '240.75 2% 85%',
      ring: '153.85 17% 67%',
      card: '0 0% 100%',
      'card-foreground': '165.48 2% 35%',
      popover: '0 0% 100%',
      'popover-foreground': '165.48 2% 35%',
      'chart-1': '153.85 17% 67%',
      'chart-2': '270.06 10% 50%',
      'chart-3': '201.79 12% 72%',
      'chart-4': '100.65 10% 80%',
      'chart-5': '300.14 15% 60%',
      'sidebar-background': '238.45 1% 98%',
      'sidebar-foreground': '165.48 2% 35%',
      'sidebar-primary': '153.85 17% 67%',
      'sidebar-primary-foreground': '238.45 1% 98%',
      'sidebar-accent': '240.73 2% 90%',
      'sidebar-accent-foreground': '165.48 2% 35%',
      'sidebar-border': '240.75 2% 85%',
      'sidebar-ring': '153.85 17% 67%',
    },
    radius: '0.25rem',
    fonts: {
...
export const darkThemes: Record<string, Theme> = {
  ...
  spotify: {
    ...
    mode: 'dark',
    colors: {
      background: '269.18 2% 15%',
      foreground: '238.46 1% 95%',
      primary: '153.85 17% 67%',
      'primary-foreground': '269.18 2% 15%',
      secondary: '271.05 3% 30%',
      'secondary-foreground': '238.46 1% 95%',
      accent: '271.05 3% 30%',
      'accent-foreground': '238.46 1% 95%',
      muted: '271.05 3% 30%',
      'muted-foreground': '269.46 3% 60%',
      destructive: '19.69 25% 64%',
      'destructive-foreground': '0 0% 98%',
      border: '238.46 1% 95%',
      input: '238.46 1% 95%',
      ring: '153.85 17% 67%',
      card: '266.02 2% 20%',
      'card-foreground': '238.46 1% 95%',
      popover: '266.02 2% 20%',
      'popover-foreground': '238.46 1% 95%',
      'chart-1': '153.85 17% 67%',
      'chart-2': '269.83 10% 60%',
      'chart-3': '201.79 12% 72%',
      'chart-4': '100.65 10% 80%',
      'chart-5': '300.14 15% 60%',
      'sidebar-background': '266.02 2% 20%',
      'sidebar-foreground': '238.46 1% 95%',
      'sidebar-primary': '153.85 17% 67%',
      'sidebar-primary-foreground': '269.18 2% 15%',
      'sidebar-accent': '271.05 3% 30%',
      'sidebar-accent-foreground': '238.46 1% 95%',
      'sidebar-border': '238.46 1% 95%',
      'sidebar-ring': '153.85 17% 67%',
    },
    radius: '0.25rem',
    fonts: {
